...
namespace CanyonShooter.ParticleEngine
{
    ...
    /// </summary>
    public class BlastPipeEmitter : Effect
    {
        public BlastPipeEmitter(ICanyonShooterGame game, EffectType type, ParticleSettings settings)
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            {
                this.AddParticle(this.GlobalPosition,Vector3.Transform(new Vector3(0, 0, 1), GlobalRotation));
