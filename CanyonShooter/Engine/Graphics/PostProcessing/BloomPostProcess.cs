...
namespace CanyonShooter.Engine.Graphics.PostProcessing
{
    ...
    public class BloomPostProcess : DrawableGameComponent, IPostProcess
    {
        #region File Description
        //-----------------------------------------------------------------------------
        // BloomSettings.cs
        ...
        public class BloomSettings
        {
            ...
            public static BloomSettings[] PresetSettings =
            {
                ...
                new BloomSettings("Default",     0.25f,  6,   1.55f, 1,    1,       1),
        ...
        public BloomPostProcess(ICanyonShooterGame game)
            : base(game as Game)
        {
            this.game = game;
        ...
        protected override void LoadContent()
        {
            ...
            bloomExtractEffect = Game.Content.Load<Effect>("Content\\Effects\\PostProcessing\\BloomExtract");
            bloomCombineEffect = Game.Content.Load<Effect>("Content\\Effects\\PostProcessing\\BloomCombine");
            gaussianBlurEffect = Game.Content.Load<Effect>("Content\\Effects\\PostProcessing\\GaussianBlur");
