...
{
    class Player2: GameObject,  IPlayer
    {
        ...
        private float minSpeed = 250;                   // Minimal speed
        ...
        public float angVert = 0;                      // Current vertical angle
        public float angRoll = 0;                      // Current rolling level
        public float angHorz = 0;                      // Current horizontal angle
        ...
        public float mouseY;
        // Spacemouse Hack
        public bool hasSpaceMouse = false;
        ...
        public override void OnCollision(CollisionEvent e)
        {
            ...
            if (collisionObject.ContactGroup == Engine.Physics.ContactGroup.Waypoint)
            {
                if (((WaypointObject)collisionObject).SecondsToAdd > 0)
                {
                    ...
                    game.GameStates.Score.KilledEnemy += 5;
                    game.GameStates.Score.AddPoints(500);
                }
            }
        ...
        protected override void LoadContent()
        {
            ...
            if (Weapons == null)
            {
                ...
                //Weapons.SetSecondaryWeapon(WeaponType.MINIGUN2);
            ...
            // Initiate the hurry up sound
            hurryUpEfx = game.Sounds.CreateSound("Clock");
            gameOverEfx = game.Sounds.CreateSound("GameOver");
